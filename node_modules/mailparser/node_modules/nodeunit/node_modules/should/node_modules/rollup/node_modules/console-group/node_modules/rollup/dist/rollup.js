/*
	Rollup.js v0.23.2
	Sat Jan 02 2016 15:13:21 GMT-0500 (EST) - commit 643d85f36d0e2513c7f8d68e8ccfe1e4227f170b
...
pp$1.isUseStrict = function (stmt) {
...
pp$1.afterTrailingComma = function (tokType) {
...
pp$1.checkPatternErrors = function (refDestructuringErrors, andThrow) {
...
function collapseSourcemaps(map, modules, bundleSourcemapChain) {
	var sources = modules.map(function (module, i) {
		var source = { isOriginal: true, index: i };
	...
	var source = new Source(map, sources);
